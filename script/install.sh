...
if [ ! -d "opt/simp_le" ]; then
    if git clone https://github.com/kuba/simp_le opt/simp_le; then
        ...
        echo "See the LET'S ENCRYPT section in the README and https://github.com/kuba/simp_le to finish the installation if you want to use Let's encrypt to manage the SSL certificates."
    fi
fi
