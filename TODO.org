...
* TODO proper fixed category handling

** TODO In the creation menu, offer checkboxes
** TODO In the edit page, list them.
** TODO Indexing probably need to ignore other topics
** TODO The fixes categories are codes
