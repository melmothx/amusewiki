...
* DONE HTTPS support
  CLOSED: [2014-09-23 mar 15:16]

Unclear if needed to enforce it or not. Pain in the ass for the
multisite thing.

** DONE Change site.canonical to be without protocol.
   CLOSED: [2014-09-22 lun 21:58]

** DONE When looking up the virtual host, check first against canonical
   CLOSED: [2014-09-22 lun 21:58]

This way, we can save a query against the vhost table

** In the install script, set the secure_site flag to true.

Not needed.

** DONE Do not use https:// with canonical_url, but only where it makes sense.
   CLOSED: [2014-09-23 mar 13:30]

** DONE Add a script to generate the certificate with alternate names
   CLOSED: [2014-09-23 mar 15:16]
...
Won't fix. The pop up has the same purpose. Too late now.
...
* DONE git clone urls in cgit
  CLOSED: [2014-09-19 ven 17:02]
