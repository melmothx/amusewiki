...
* TODO fix crash on garbage with language. test required.
* TODO remove bullets from list of latest entries
* TODO remove the grey left margin from blockquotes
* TODO add logo centered before latest entries.
* TODO Right align the options?
