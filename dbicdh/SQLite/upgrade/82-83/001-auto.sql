...
;
INSERT INTO site_temp_alter( id, mode, locale, magic_question, magic_answer, fixed_category_list, sitename, siteslogan, theme, logo, mail_notify, mail_from, canonical, secure_site, secure_site_only, sitegroup, cgit_integration, ssl_key, ssl_cert, ssl_ca_cert, ssl_chained_cert, acme_certificate, multilanguage, active, blog_style, bb_page_limit, tex, pdf, a4_pdf, lt_pdf, sl_pdf, html, bare_html, epub, zip, ttdir, papersize, division, bcor, fontsize, mainfont, sansfont, monofont, beamertheme, beamercolortheme, nocoverpage, logo_with_sitename, opening, twoside, binary_upload_max_size_in_mega, git_token, last_updated) SELECT id, mode, locale, magic_question, magic_answer, fixed_category_list, sitename, siteslogan, theme, logo, mail_notify, mail_from, canonical, secure_site, secure_site_only, sitegroup, cgit_integration, ssl_key, ssl_cert, ssl_ca_cert, ssl_chained_cert, acme_certificate, multilanguage, active, blog_style, bb_page_limit, tex, pdf, a4_pdf, lt_pdf, sl_pdf, html, bare_html, epub, zip, ttdir, papersize, division, bcor, fontsize, mainfont, sansfont, monofont, beamertheme, beamercolortheme, nocoverpage, logo_with_sitename, opening, twoside, binary_upload_max_size_in_mega, git_token, last_updated FROM site;
...
;
INSERT INTO site SELECT id, mode, locale, magic_question, magic_answer, fixed_category_list, sitename, siteslogan, theme, logo, mail_notify, mail_from, canonical, secure_site, secure_site_only, sitegroup, cgit_integration, ssl_key, ssl_cert, ssl_ca_cert, ssl_chained_cert, acme_certificate, multilanguage, active, blog_style, bb_page_limit, tex, pdf, a4_pdf, lt_pdf, sl_pdf, html, bare_html, epub, zip, ttdir, papersize, division, bcor, fontsize, mainfont, sansfont, monofont, beamertheme, beamercolortheme, nocoverpage, logo_with_sitename, opening, twoside, binary_upload_max_size_in_mega, git_token, last_updated FROM site_temp_alter;
...
;
ALTER TABLE users ADD COLUMN api_access_created datetime;

;
ALTER TABLE whitelist_ip ADD COLUMN granted_by_username varchar(255);
