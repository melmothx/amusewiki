...
;
INSERT INTO title_temp_alter( id, title, subtitle, lang, date, notes, source, list_title, author, uid, attach, pubdate, status, f_path, f_name, f_archive_rel_path, f_timestamp, f_timestamp_epoch, f_full_path_name, f_suffix, f_class, uri, deleted, slides, text_structure, cover, teaser, sorting_pos, sku, text_qualification, text_size, attachment_index, site_id) SELECT id, title, subtitle, lang, date, notes, source, list_title, author, uid, attach, pubdate, status, f_path, f_name, f_archive_rel_path, f_timestamp, f_timestamp_epoch, f_full_path_name, f_suffix, f_class, uri, deleted, slides, text_structure, cover, teaser, sorting_pos, sku, text_qualification, text_size, attachment_index, site_id FROM title;
...
;
INSERT INTO title SELECT id, title, subtitle, lang, date, notes, source, list_title, author, uid, attach, pubdate, status, f_path, f_name, f_archive_rel_path, f_timestamp, f_timestamp_epoch, f_full_path_name, f_suffix, f_class, uri, deleted, slides, text_structure, cover, teaser, sorting_pos, sku, text_qualification, text_size, attachment_index, site_id FROM title_temp_alter;
