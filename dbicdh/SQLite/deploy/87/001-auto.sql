...
-- Created on Tue Oct 14 10:58:15 2025
--
...
CREATE INDEX "bookcover_token_name_amw_index" ON "bookcover_token" ("token_name");
--
-- Table: "job_file"
--
...
CREATE TABLE "oai_pmh_record" (
  ...
  FOREIGN KEY ("aggregation_id") REFERENCES "aggregation"("aggregation_id") ON DELETE SET NULL ON UPDATE CASCADE,
  FOREIGN KEY ("aggregation_series_id") REFERENCES "aggregation_series"("aggregation_series_id") ON DELETE SET NULL ON UPDATE CASCADE,
