...
** TODO git support in Archive::Edit and Archive

** TODO original text in revision Archive::Edit

** TODO plug the preprocessor in Schema::Result::Revision

** TODO store the pdf attachmentes in a directory by themselves

** TODO when publishing a revision, do not overwrite anything.

(and store every change in the git)

** TODO check if the original revision file matches the one we are going to overwrite.
