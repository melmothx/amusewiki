-- Convert schema 'sql/AmuseWikiFarm-Schema-0.11-MySQL.sql' to 'AmuseWikiFarm::Schema v0.12':;
...
ALTER TABLE site DROP COLUMN mail,
                 ADD COLUMN mail_notify varchar(255) NULL,
                 ADD COLUMN mail_from varchar(255) NULL,
