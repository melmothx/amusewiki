-- Convert schema 'sql/AmuseWikiFarm-Schema-0.95-MySQL.sql' to 'AmuseWikiFarm::Schema v0.96':;

BEGIN;

ALTER TABLE attachment DROP FOREIGN KEY attachment_fk_site_id;

ALTER TABLE attachment CHANGE COLUMN f_archive_rel_path f_archive_rel_path varchar(32) NOT NULL,
                       CHANGE COLUMN site_id site_id varchar(16) NOT NULL,
                       ADD CONSTRAINT attachment_fk_site_id FOREIGN KEY (site_id) REFERENCES site (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE category DROP FOREIGN KEY category_fk_site_id;

ALTER TABLE category CHANGE COLUMN site_id site_id varchar(16) NOT NULL,
...
ALTER TABLE job CHANGE COLUMN site_id site_id varchar(16) NOT NULL,
                ADD CONSTRAINT job_fk_site_id FOREIGN KEY (site_id) REFERENCES site (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE redirection DROP FOREIGN KEY redirection_fk_site_id;

ALTER TABLE redirection CHANGE COLUMN site_id site_id varchar(16) NOT NULL,
                        ADD CONSTRAINT redirection_fk_site_id FOREIGN KEY (site_id) REFERENCES site (id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE revision DROP FOREIGN KEY revision_fk_site_id,
                     DROP FOREIGN KEY revision_fk_title_id;

ALTER TABLE revision CHANGE COLUMN site_id site_id varchar(16) NOT NULL,
                     ADD CONSTRAINT revision_fk_site_id FOREIGN KEY (site_id) REFERENCES site (id) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE title CHANGE COLUMN f_archive_rel_path f_archive_rel_path varchar(32) NOT NULL,
                  CHANGE COLUMN site_id site_id varchar(16) NOT NULL,
                  ADD CONSTRAINT title_fk_site_id FOREIGN KEY (site_id) REFERENCES site (id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE user_site CHANGE COLUMN site_id site_id varchar(16) NOT NULL,
                      ADD CONSTRAINT user_site_fk_site_id FOREIGN KEY (site_id) REFERENCES site (id) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE vhost CHANGE COLUMN site_id site_id varchar(16) NOT NULL,
                  ADD CONSTRAINT vhost_fk_site_id FOREIGN KEY (site_id) REFERENCES site (id) ON DELETE CASCADE ON UPDATE CASCADE;
