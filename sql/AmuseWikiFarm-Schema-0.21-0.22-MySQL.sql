-- Convert schema 'sql/AmuseWikiFarm-Schema-0.21-MySQL.sql' to 'AmuseWikiFarm::Schema v0.22':;
...
ALTER TABLE site CHANGE COLUMN sitegroup sitegroup varchar(255) NOT NULL DEFAULT '',
                 CHANGE COLUMN multilanguage multilanguage varchar(255) NOT NULL DEFAULT '';

ALTER TABLE title DROP FOREIGN KEY title_fk_site_id;

ALTER TABLE title CHANGE COLUMN uid uid varchar(255) NOT NULL DEFAULT '',
