-- Convert schema 'sql/AmuseWikiFarm-Schema-0.992-MySQL.sql' to 'AmuseWikiFarm::Schema v0.998':;
...
ALTER TABLE site ADD COLUMN secure_site integer(1) NOT NULL DEFAULT 0,
                 CHANGE COLUMN canonical canonical varchar(255) NOT NULL,
                 ADD UNIQUE canonical_unique (canonical);
