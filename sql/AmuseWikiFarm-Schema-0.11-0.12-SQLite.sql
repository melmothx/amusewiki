-- Convert schema 'sql/AmuseWikiFarm-Schema-0.11-SQLite.sql' to 'sql/AmuseWikiFarm-Schema-0.12-SQLite.sql':;
...
INSERT INTO site_temp_alter( id, mode, locale, magic_question, magic_answer, fixed_category_list, sitename, siteslogan, theme, logo, canonical, sitegroup, bb_page_limit, tex, pdf, a4_pdf, lt_pdf, html, bare_html, epub, zip, ttdir, papersize, division, bcor, fontsize, mainfont, twoside) SELECT id, mode, locale, magic_question, magic_answer, fixed_category_list, sitename, siteslogan, theme, logo, canonical, sitegroup, bb_page_limit, tex, pdf, a4_pdf, lt_pdf, html, bare_html, epub, zip, ttdir, papersize, division, bcor, fontsize, mainfont, twoside FROM site;
